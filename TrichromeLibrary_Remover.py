...
def main():
    ...
    func('com.google.android.trichromelibrary',
         version_code_stable_new, arm_target_new)  # 81~100

    func('com.google.android.trichromelibrary.beta',
         version_code_beta_old, arm_target_old)  # 75~80

    func('com.google.android.trichromelibrary.beta',
         version_code_beta_new, arm_target_new)  # 81~101
...
version_code_stable_new = [
    ...
    [4606, [85, 80, 71, 61]],  #94
    [4577, [82, 62]],  #93
    [4515, [166, 159, 131, 115, 105]],  #92
    [4472, [164, 134, 120, 114, 101, 88, 77, 35, 16]],  #91
    [4430, [210, 91, 82, 66]],  #90
    [4389, [105, 90, 86, 72]],  # 89
...
version_code_beta_new = [
    [4951, [26, 15]], #101
    [4896, [58, 56, 46, 30, 18]], #100
    [4844, [48, 44, 35, 27, 16]], #99
    [4758, [87, 72, 63, 54, 46, 34]], #98
    [4692, [70, 56, 36, 20]],  #97
    [4664, [45, 35, 27, 17]],  #96
    [4638, [50, 40, 32, 16]],  #95
    [4606, [50, 40, 31, 19]],  #94
    [4577, [58, 51, 37, 25, 15]],  #93
    [4515, [115, 105, 101, 92, 80, 70, 59, 51, 40]],  #92
    [4472, [88, 77, 70, 54, 35, 28, 16]],  #91
    [4430, [82, 66, 61, 51, 40, 30, 19]],  # 90
